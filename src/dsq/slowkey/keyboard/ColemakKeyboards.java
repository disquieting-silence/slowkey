...
public class ColemakKeyboards implements Keyboards {
    ...
    public ColemakKeyboards(final Context context, final Window window) {
        ...
        final Keyboard colemakAlpha = new DynamicKeyboard(context, R.xml.colemak_alpha);
        final Keyboard megaSymbols = new DynamicKeyboard(context, R.xml.mega_symbols);
...
//        mapping.put(COLEMAK_ALPHA_9, colemakAlpha9);
//        mapping.put(COLEMAK_ALPHA_7, colemakAlpha7);
